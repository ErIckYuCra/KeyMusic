...
import { getAlbumArtist, getArtist, getRelatedArtist, getTopSongsArtist } from '../../../utils/getDataApi/dataGetDataArtist'
...
function ContentArtist() {
    ...
    async function getData() {
        ...
        const artistData = await getArtist("3vKxuOGRkXJWpCZPf01Nj8", token)
        const listMusicData = await getTopSongsArtist(artistData.id_artist, token)
    ...
    return <section id="contenido-artista">
        ...
        <section id='music_artist'>
            <MusicData music_data={listMusic} music_header={"Top Canciones"} link={"*"} music_link={""}></MusicData>
        </section>
